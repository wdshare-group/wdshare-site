...
;(function(factory) {
	...
	else if (typeof define === "function")  // AMD/CMD/Sea.js
	{
        ...
        {
            var cmModePath  = "../../plugin/editor.md/lib/codemirror/mode/";
            var cmAddonPath = "../../plugin/editor.md/lib/codemirror/addon/";

            var codeMirrorModules = [
                "jquery", "marked", "prettify",
                "katex", "raphael", "underscore", "flowchart",  "jqueryflowchart",  "sequenceDiagram",

                "../../plugin/editor.md/lib/codemirror/lib/codemirror",
                cmModePath + "css/css",
    ...
    editormd.defaults     = {
        ...
        width                : "100%",
        height               : "100%",
        path                 : "../../plugin/editor.md/",       // Dependents module file directory
